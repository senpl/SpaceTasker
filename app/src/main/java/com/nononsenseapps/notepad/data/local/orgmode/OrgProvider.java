...
import static com.nononsenseapps.notepad.data.local.orgmode.OrgConverter.getNodeId;
import static com.nononsenseapps.notepad.data.local.orgmode.ProviderUtils.KEY_TITLE;
...
public class OrgProvider extends ContentProvider {
    ...
    private String getDir() {
        return SharedPreferencesHelper.getSdDir(getContext());
    }
    ...
    public Cursor query(Uri uri, String[] projection, String selection,
        ...
        if (!SharedPreferencesHelper.isSdSyncEnabled(getContext())) {
            return null;
        }
    ...
    private Cursor queryItem(Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder) {
        throw new UnsupportedOperationException("Not yet implemented");
    }

    private Cursor queryFile(Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder) {
        throw new UnsupportedOperationException("Not yet implemented");
    }

    private Cursor queryFiles(Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder) {
        throw new UnsupportedOperationException("Not yet implemented");
    }
}
